    ...
    <div ref={containerRef} className="flex flex-col h-full p-6">
      ...
      <div className="grid grid-cols-4 gap-3">
        {stack.map((tech) => (
          <div
            key={tech.name}
            className="tech-item flex flex-col items-center justify-center gap-2 p-3 rounded-xl bg-neutral-50 dark:bg-neutral-800/50 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors group cursor-default border border-neutral-100 dark:border-neutral-800"
          >
            <tech.icon
              size={20}
