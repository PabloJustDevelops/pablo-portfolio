...
export function ExperienceTimeline({ items }: { items: ExperienceItem[] }) {
  ...
  return (
    <div ref={sectionRef} className="relative md:grid md:grid-cols-[1fr_80px_1.6fr]">
      ...
      <div className="hidden md:block pointer-events-none md:col-start-2 md:col-end-3 md:[grid-row:1/-1] z-20 flex justify-center">
        <div className="sticky top-0 h-screen flex items-center justify-center">
          <div className="relative h-[70vh] w-[80px] flex items-stretch justify-center">
            <div ref={desktopRailRef} className="relative h-full w-[2px] bg-white/15 dark:bg-white/20 rounded-full">
              <div
                ref={desktopHaloRef}
                className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2"
                style={{ top: 0 }}
      ...
      {items.map((exp, idx) => (
        <section
          ...
          className="relative border-b border-black/5 dark:border-white/5 md:border-b-0 md:contents"
        >
          <Fragment>
            <div className="pl-12 pr-6 py-10 md:px-6 md:py-12 md:min-h-[85vh] md:col-start-1 md:border-b md:border-black/5 md:dark:border-white/5">
            ...
            <div className="hidden md:block md:col-start-2 md:border-b md:border-black/5 md:dark:border-white/5" />

            <div className="pl-12 pr-6 pb-10 md:px-6 md:py-12 md:min-h-[85vh] md:col-start-3 md:border-b md:border-black/5 md:dark:border-white/5 flex flex-col gap-6">
